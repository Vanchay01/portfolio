          ...
          {skill.map((s) => (
            <div key={s.id} className="box-skill font-medium">
              ...
              <div className="w-full max-w-xs py-2">
                <div className="h-3 w-full bg-gray-300 dark:bg-gray-600 rounded-full overflow-hidden relative transition duration-300">
                  <div
                ...
                <p className="mt-2 text-sm text-green-500 text-right">{s.rating}%</p>
              </div>
            </div>
          ))}
        </div>
